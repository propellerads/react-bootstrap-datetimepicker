...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.onChange = function (event) {
      ...
      return _this.setState({
        ...
        var date = (0, _moment2["default"])(this.state.inputValue, this.state.inputFormat, true);
    ...
    this.onClick = function () {
      ...
      if (_this.state.showPicker) {
        ...
        var inputWidth = _this.refs.dtpinput.getBoundingClientRect().width;
        classes = {
        ...
        if (offset.left + gBCR.width - calendarPanelWidth < 0) {
          styles.left = inputWidth;
    ...
    this.closePicker = function () {
      var style = _Object$assign({}, _this.state.widgetStyle);
      style.left = -9999;
      style.display = "none";
      return _this.setState({
        showPicker: false,
  ...
  _createClass(DateTimeField, [{
    key: "initSelectedDate",
    value: function initSelectedDate() {
      var date = (0, _moment2["default"])(this.props.dateTime, this.props.format, true);
      return date.isValid() ? date : (0, _moment2["default"])();
    }
  }, {
    key: "initViewDate",
    value: function initViewDate() {
      var date = (0, _moment2["default"])(this.props.dateTime, this.props.format, true);
      return date.isValid() ? date.startOf("month") : (0, _moment2["default"])().startOf("month");
    }
  }, {
    key: "initInputValue",
    value: function initInputValue() {
      var inputFormat = this.resolvePropsInputFormat();
      var date = (0, _moment2["default"])(this.props.dateTime, this.props.format, true);
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("input", _extends({ className: "form-control", onChange: this.onChange, type: "text", ref: "dtpinput", value: this.state.inputValue }, this.props.inputProps)),
          _react2["default"].createElement(
            "span",
